...
?>
				<p>
					<input id="level_<?php echo $level['id']; ?>" type="radio" class="with-gap" name="niveau" value="<?php echo $level['id']; ?>"/>
...
?>
				<p>
					<input id="skill_<?php echo $skill['id']; ?>" type="checkbox" class="filled-in" name="competence[]" value ="<?php echo $skill['id']; ?>"/>
