<div class="container">
			...
			<div class="col s12 m6">
				<div class="card">
					<div class="card-image">
						<img src="<?php echo $subject['image'] ? $subject['image'] : '../info405/image.png'; ?>">
					</div>
					<div class="card-content">
						<?php foreach (recupere_tag_par_sujet($_GET['id']) as $tag) { ?>
	...
	?>
		...
		<?php
			if($message['id_auteur'] == $_SESSION['user']['id']) {
		?>
						- <a href="?page=subject&id=<?php echo $_GET['id']; ?>&id_message=<?php echo $message['id']; ?>&state=del" class="red-text">Supprimer</a>
		<?php
			}
		?>
					</div>
	...
	?>
		...
		<ul class="collection">
			...
			<li class="collection-item avatar">
				<img src="<?php echo $subject['image'] ? $subject['image'] : '../info405/image.png'; ?>" class="circle">
